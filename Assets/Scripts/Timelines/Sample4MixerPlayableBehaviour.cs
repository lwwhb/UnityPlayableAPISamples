...
namespace TimelineSample4
{
    ...
    public class Sample4MixerPlayableBehaviour : PlayableBehaviour
    {
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                ScriptPlayable<Sample4PlayableBehaviour> inputPlayable = (ScriptPlayable<Sample4PlayableBehaviour>)playable.GetInput(i);
                Sample4PlayableBehaviour input = inputPlayable.GetBehaviour();
